...
?>
	...
	<div class="container">
			...
			if(isset($_POST["proceed_save"]))
			{
				...
				$ini_array["website"]["show_results"]=stripslashes($_POST["show_results"]);
				$ini_array["website"]["only_one_per_ip"]=stripslashes($_POST["only_one_per_ip"]);
					...
					<input type="hidden" name="proceed_save" value="1"/>
						...
						<fieldset>
							...
							<ol>
								...
								<li>
									<label><?php echo $this->texts["show_results_after_vote"];?>:</label>
									
									<select name="show_results">
										<option value="0" <?php if($ini_array["website"]["show_results"]=="0") echo "selected";?>><?php echo $this->texts["no_word"];?></option>
										<option value="1" <?php if($ini_array["website"]["show_results"]=="1") echo "selected";?>><?php echo $this->texts["yes_word"];?></option>
									</select>
									
								</li>
								<li>
									<label><?php echo $this->texts["only_one_per_ip"];?>:</label>
									
									<select name="only_one_per_ip">
										<option value="0" <?php if($ini_array["website"]["only_one_per_ip"]=="0") echo "selected";?>><?php echo $this->texts["no_word"];?></option>
										<option value="1" <?php if($ini_array["website"]["only_one_per_ip"]=="1") echo "selected";?>><?php echo $this->texts["yes_word"];?></option>
									</select>
